...
public class Date {
	...
	*/
	public Date(int day, int month, int year) throws DateException{
		...
		*/
		if(year < 1){
			throw new DateException("El año " + month + " no puede ser negativo");
		}else{
			this.year = year;
		}
		/*
		...
		*/
		if (month < 1 || month > 12) {
			throw new DateException("El mes " + month + " no es valido. Valores posibles entre 1 y 12.");
		} else {
			this.month = month;
		}
		/*
		...
		*/
		if (day < 1 || day > 31){
			throw new DateException("El dia " + day + " no es válido. Valores posibles entre 1 y 31.");
		}else{
			this.day = day;
		}
	}
